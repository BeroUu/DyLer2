...
send(msg.chat_id,msg.id,'*\n↯︙ عليك الاشتراك في قناة السورس لاستخدام الاوامر*',"md",false, false, false, false,LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = "t.me/venox_source"}}}})
return false
end
end
...
local N = (Redis:get(DyLer.."Name:Bot") or "براند")
...
{
{text = '❲ Venox Team ❳', url = "https://t.me/venox_source"}
},
}
...
data = {
{
{text = '‹ Venox Team ›', url = 't.me/'..chsource..''}, 
},
}
}
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/venox_source'}, },}}
return send(msg.chat_id,msg.id,'*\n↯︙ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
data = {
{
{text = ' ❨Source channel❩', url = 't.me/venox_source'}, 
},
}
}
return send(msg_chat_id,msg_id,"[~ Welcome to Source Venox Team ](tg://user?id=5984712101)","md",true, false, false, true, reply_markup)
end
...
{
{text = '- Venox Team ٠', url = 't.me/venox_source'}, 
},
}
}
...
LuaTele.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@venox_source")
sleep(1)
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n*•  فينوكسماعنده حساب بالبنك 🤣*","md",true)  
return false
end
...
local datar = {data = {{text = "‹ Venox Team ›" , url = 'https://t.me/venox_source'}}}
for i = 1,5 do
...
{
{text = '❨Dev Source❩', url = "https://t.me/Q0OO0"},{text = '❨Exp Source❩', url = "https://t.me/Exp_venox"},
},
{
...
if text == (Redis:get(DyLer.."Name:Bot") or "براند") then
if Redis:get(DyLer.."name bot type : ") == "photo" then
  ...
  if photo.total_count > 0 then
    local NamesBot = (Redis:get(DyLer.."Name:Bot") or "براند")
    local NameBots = {
"قلب "..NamesBot ,
"كول حبيبي ؟ شرايود 😂",
...
local CmdStart = '*\n↯︙ اهلا بك عزيزي انا بوت '..(Redis:get(DyLer.."Name:Bot") or "براند")..
...
Redis:del(DyLer.."set:chs"..msg.sender.user_id)
send(msg_chat_id,msg_id,'تم حفظ معرف ‹ Venox Team › ',"md",true)  
dofile('DyLer.lua')  
else
send(msg_chat_id,msg_id,'المعرف خطأ ',"md",true)  
end
...
reply_markup = {
inline_keyboard ={
{{text ="ch", url= "https://t.me/venox_source"}},
}
},
},
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ DyLer',url='https://t.me/venox_source'}},
}
...
local TextHelp = [[*
↯︙ أهلا بك في قائمة العاب سورس فينوكساختر نوع الالعاب 
*]]
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
↯︙ مرحبا بك في الالعاب المتطورة الخاص بسورس فينوكس
